        ...
        <Row className="flex justify-between flex-col md:flex-row ">
          <Col lg="4" md="6">
            ...
            <ul className={`${classes.contact__info__list}`}>
              ...
              <li className={`${classes.info__item}`}>
                <span>
                  <a href="mailto:tarun.softengg@gmail.com">
                    <i className="ri-mail-line"></i>
                  </a>
                </span>
                <p>
                  <a className="hover:text-[#01d293]" href="mailto:tarun.softengg@gmail.com">
                    tarun.softengg@gmail.com
                  </a>
                </p>
              </li>
            </ul>
            ...
            <div className={`${classes.social__links}`}>
              <Link
                ...
                href="https://www.youtube.com/@lifewithcode"
                target="_blank"
              >
                <RiYoutubeFill />
              </Link>
              ...
              <Link
                ...
                href="https://www.linkedin.com/in//code-with-tkssharma-7b4167275/"
                target="_blank"
              >
                <RiLinkedinFill />
              </Link>
