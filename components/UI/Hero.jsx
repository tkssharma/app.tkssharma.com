...
import heroImg from "../../public/images/me.jpg";
        ...
        <Row>
          <Col lg="6" md="6">
            <div className={`${classes.hero__content}`}>
              ...
              <h2 className="mt-3 mb-3">I&apos;m Tarun Sharma </h2>
              <h5 className="mb-4">Fullstack Developer & Instructor</h5>
              <p id="about-me">
                Hi there! My name is Tarun Sharma @tkssharma  and I&rsquo;m a software
                engineer with over 10 years of experience in the industry. I love
            ...
            <div className="mt-5 flex place-content-center md:block">
              <div className="relative inline-flex group">
                ...
                <Link
                  target="_blank"
                  href="https://discord.gg/tkssharma"
          ...
          <Col lg="6" md="6">
            <div className={`${classes.hero__img} text-end`}>
              <Image alt="Tarun Sharma " src={heroImg} width="450" height="450" />
            </div>
          </Col>
        </Row>
      </Container>
          ...
          <Col lg="6" md="6">
            <div className={`${classes.hero__content}`}>
              <div className="flex flex-col items-center justify-center">
                ...
                <p id="about-me" className="text-center">
                  Hi there! My name is Tarun Sharma  and I&rsquo;m a software
            ...
            <div className="mt-5 flex flex-col items-center justify-center">
              <div className="relative inline-flex group">
                ...
                <Link
                  target="_blank"
                  href="https://discord.gg/ZbxMJBGx"
